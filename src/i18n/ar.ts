...
export const ar: Dictionary = {
  ...
  hero: {
    ...
    summary:
      "مهندس full-stack بأكثر من أربع سنوات على Java 21 وSpring Boot للقطاع العام والمؤسسات: واجهات Angular وReact، خدمات مصغّرة قائمة على الأحداث، وKeycloak للهوية. مقيم في الرباط. يعمل بالفرنسية والإنجليزية والعربية. منفتح على أدوار مهندس برمجيات وFull-Stack في أوروبا الناطقة بالفرنسية.",
  ...
  about: {
    heading: "نبذة",
    paragraphs: [
      "أنا مهندس برمجيات Full-Stack في الرباط. منذ سبتمبر 2024 أعمل مهندسًا مستقلًا لدى وكالة التنمية الرقمية (ADD)، الوكالة الوطنية المغربية للتنمية الرقمية: خدمات Java 21 وSpring Boot، واجهات Angular وReact، Redis وKafka بين الخدمات، Docker وKubernetes للتسليم، وKeycloak للهوية. Mendix أداة أستخدمها عندما يقتضي الطلب ذلك — وليست محور العمل.",
  ...
  contact: {
    heading: "التواصل",
    intro:
      "مقيم في الرباط. منفتح على أدوار مهندس برمجيات وFull-Stack في أوروبا الناطقة بالفرنسية.",
    email: "البريد",
    phone: "الهاتف",
    linkedin: "LinkedIn",
    github: "GitHub",
